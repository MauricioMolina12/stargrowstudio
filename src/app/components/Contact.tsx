    ...
    return (
        <div className="w-full h-auto min-h-[100vh] lg:max-w-[70%] lg:mx-auto lg:my-0">
            <aside className="w-full h-1/2 flex flex-col items-center justify-center gap-2.5 p-4 parallax">
                <span className="text-[var(--color-white)] parallax">Contacto</span>
                <h1 className="text-3xl text-[var(--color-white)] text-center font-bold lg:w-[70%] lg:text-4xl parallax">Contáctanos Aquí ✉️</h1>
            </aside>
            <form ref={formRef} onSubmit={sendEmail} className="flex flex-col lg:w-3/4 lg:mx-auto lg:my-0">
                <div className="forms w-full h-1/2 px-4">
                    <div className="username w-full flex flex-col lg:flex-row items-center justify-between gap-3">
                        <div className="name w-full flex flex-col py-4">
                            <label htmlFor="name" className="parallax text-[var(--color-gray)] font-medium text-[1rem]">Nombre</label>
                        ...
                        <div className="email w-full flex flex-col py-4">
                            <label htmlFor="email" className="parallax text-[var(--color-gray)] font-medium text-[1rem]">Correo</label>
                ...
                <div className="forms w-full h-1/2 px-4">
                    <div className="businness w-full flex flex-col items-center justify-between">
                        <div className="entity w-full flex flex-col py-4">
                            <label htmlFor="entity" className="parallax text-[var(--color-gray)] text-[1rem] font-medium">Empresa <span>(Opcional)</span></label>
                        ...
                        <div className="message w-full flex flex-col py-4">
                            <label htmlFor="message" className="parallax text-[var(--color-gray)] text-[1rem] font-medium">Mensaje</label>
                ...
                <div className="button-submit px-4 w-full">
                    <button type="submit" className="parallax flex justify-center items-center w-full lg:w-1/2 lg:ml-auto h-full bg-[var(--color-white)] text-[var(--color-primary)] font-bold py-4 rounded-2xl cursor-pointer">
                        {loading && (
